...
const messages: LocaleMessages = {
  app: {
    ...
    login: {
      ...
      codexBridgeHint: 'vis_bridge remains the required remote-safe boundary between Vis/Electron and Codex CLI.',
  ...
  providerManager: {
    ...
    custom: {
      ...
      back: 'Back',
      description: 'Configure an OpenAI-compatible provider. See the provider configuration docs for advanced options.',
      ...
      fields: {
        ...
        apiKey: {
          label: 'API key',
          placeholder: 'API key',
          description: 'Optional. Leave empty if authentication is managed through request headers.',
        },
      },
      models: {
        label: 'Models',
      ...
      errors: {
        ...
        codexEnvKeyRequired: 'Use {env:ENV_VAR} for Codex API keys; raw keys are not written to config.toml.',
        required: 'Required.',
  ...
  settings: {
    ...
    theme: {
      ...
      presetDescription: 'Select a curated theme profile. Custom palette editing has been replaced by preset management.',
      managementLabel: 'Theme management',
      managementDescription: 'Themes are now managed as curated profiles backed by shared design tokens. Direct per-region palette editing has been removed.',
      ...
      importHint: 'Load a theme from an external JSON file. Imported themes become available immediately.',
