...
const messages: LocaleMessages = {
  ...
  topPanel: {
    ...
    confirm: {
      ...
      archiveCodexSessions: 'Delete {count} selected Codex session(s) using native archive? VIS cannot restore them.',
    },
    meta: {
      created: 'Created',
      updated: 'Updated',
  ...
  codexPanel: {
    ...
    runtime: {
      title: 'Runtime inspector', capabilities: 'Capabilities', goal: 'Thread goal', objective: 'Objective', tokenBudget: 'Token budget', status: 'Status', usage: 'Account usage', lifetimeTokens: 'Lifetime tokens', streakDays: 'Current streak (days)', provider: 'Provider capabilities', permissionProfiles: 'Permission profiles', configRequirements: 'Config requirements', loadedThreads: 'Loaded threads', cleanBackgroundTerminals: 'Clean terminals', supported: 'Supported', unsupported: 'Unsupported', gated: 'Gated', unknown: 'Unknown', enabled: 'Enabled', disabled: 'Disabled', goalStatusActive: 'Active', goalStatusPaused: 'Paused', goalStatusBlocked: 'Blocked', goalStatusUsageLimited: 'Usage limited', goalStatusBudgetLimited: 'Budget limited', goalStatusComplete: 'Complete',
    },
    ...
    fsInspector: { title: 'File metadata & watch', path: 'Path', metadata: 'Metadata', watch: 'Watch', unwatch: 'Unwatch' },
    fsCopy: 'Copy',
