...
const BRANCHES: BranchEntry[] = [
  ...
  { file: 'App.vue', fp: "activeBackendKind.value==='kimi-web'", occurrences: 1, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'agentPickerState computed (empty list is the settled truth for kimi-web, so the composer shows the not-supported copy instead of the loading placeholder)', kimiSignal: 'agentPickerState' },
