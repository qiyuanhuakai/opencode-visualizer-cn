...
const BRANCHES: BranchEntry[] = [
  ...
  { file: 'App.vue', fp: "activeBackendKind.value!=='kimi-web'", occurrences: 1, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'light permission color backend guard', kimiSignal: 'lightPermissionColors' },
  ...
  { file: 'App.vue', fp: "activeBackendKind.value!=='acp'", occurrences: 6, classification: 'capability-optional', owner: 25, handling: 'handled', sites: 'ACP-only guards including Git status mirroring' },
  { file: 'App.vue', fp: "activeBackendKind.value!=='acp'", occurrences: 1, classification: 'capability-optional', owner: 25, handling: 'handled', sites: 'light ACP permission color backend guard' },
  ...
  { file: 'App.vue', fp: "activeBackendKind.value==='acp'", occurrences: 3, classification: 'capability-optional', owner: 25, handling: 'handled', sites: 'ACP-only selection and logout cache reset' },
  { file: 'App.vue', fp: "activeBackendKind.value==='acp'", occurrences: 2, classification: 'capability-optional', owner: 25, handling: 'handled', sites: 'ACP permission color and composer tint' },
  { file: 'components/ThreadBlock.vue', fp: "props.backendKind==='acp'", occurrences: 2, classification: 'capability-optional', owner: 25, handling: 'handled', sites: 'hide unsupported ACP checkpoint fork and revert actions' },
  ...
  { file: 'App.vue', fp: "activeBackendKind.value!=='kimi-web'", occurrences: 1, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'runtime action capability probe requires the connected Kimi backend', kimiSignal: 'probeKimiWebSessionActions' },
  ...
  { file: 'App.vue', fp: "activeBackendKind.value==='kimi-web'", occurrences: 3, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'hasAgentOptions; draft restore; handleSelectedModeUpdate mode routing', kimiSignal: 'kimiWebAgentModeOptions' },
  ...
  { file: 'App.vue', fp: "activeBackendKind==='acp'", occurrences: 4, classification: 'capability-optional', owner: 25, handling: 'handled', sites: 'composer ACP permission, Plan, and file mention props' },
  { file: 'App.vue', fp: "activeBackendKind==='codex'", occurrences: 6, classification: 'capability-optional', owner: 25, handling: 'handled', sites: 'composer Codex props including file mentions' },
  { file: 'App.vue', fp: "activeBackendKind==='kimi-web'", occurrences: 6, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'composer permission, mode, file mention, and goal props plus card metadata and file diff actions', kimiSignal: 'KimiWebComposerModes' },
  ...
  // ----- components -----
  { file: 'components/ProjectPicker.vue', fp: "getActiveBackendKind()==='codex'", occurrences: 1, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'listDirectory path split after Kimi browse', kimiSignal: 'browseDirectories' },
  { file: 'components/ProjectPicker.vue', fp: "getActiveBackendKind()==='kimi-web'", occurrences: 2, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'listDirectory global Kimi directory browse; fetchDirectory session-backed .git file detection', kimiSignal: 'browseDirectories' },
  ...
  { file: 'components/StatusMonitorModal.vue', fp: "activeBackendKind==='codex'", occurrences: 4, classification: 'ui-required', owner: 20, handling: 'handled', sites: 'Codex summary, session and account Token sections', kimiSignal: 'unsupportedKimiWeb' },
  ...
  { file: 'components/StatusMonitorModal.vue', fp: "props.activeBackendKind==='codex'", occurrences: 4, classification: 'capability-optional', owner: 20, handling: 'handled', sites: 'Codex session Token, refresh, skills sync, and summary guard' },
  { file: 'components/StatusMonitorModal.vue', fp: "props.activeBackendKind!=='opencode'", occurrences: 1, classification: 'capability-optional', owner: 20, handling: 'handled', sites: 'hide MC tab outside OpenCode' },
  { file: 'components/StatusMonitorModal.vue', fp: "props.activeBackendKind==='opencode'", occurrences: 1, classification: 'capability-optional', owner: 20, handling: 'handled', sites: 'show MC tab only in OpenCode' },
  { file: 'components/StatusMonitorModal.vue', fp: "activeBackendKind==='opencode'", occurrences: 1, classification: 'capability-optional', owner: 20, handling: 'handled', sites: 'render MC content only in OpenCode' },
  ...
  { file: 'composables/useBackendSessionLifecycle.ts', fp: "params.activeBackendKind.value==='kimi-web'", occurrences: 5, classification: 'ui-required', owner: 17, handling: 'handled', sites: 'create/reuse; picker home; existing-directory selection; handleProjectDirectorySelect; abort', kimiSignal: 'createKimiWebSessionInDirectory' },
