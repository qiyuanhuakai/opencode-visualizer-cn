...
const BRANCHES: BranchEntry[] = [
  ...
  { file: 'App.vue', fp: "case:'codex'", occurrences: 1, classification: 'ui-required', owner: 25, handling: 'pending', sites: 'currentBackendIdentity switch 5648 (no default)' },
  { file: 'App.vue', fp: "case:'acp'", occurrences: 1, classification: 'ui-required', owner: 25, handling: 'pending', sites: 'currentBackendIdentity switch 5648 (no default)' },
  { file: 'App.vue', fp: "case:'opencode'", occurrences: 1, classification: 'ui-required', owner: 25, handling: 'pending', sites: 'currentBackendIdentity switch 5648 (no default)' },
  ...
  { file: 'App.vue', fp: "loginBackendKind.value!=='acp'", occurrences: 1, classification: 'ui-required', owner: 11, handling: 'pending', sites: 'acp login agent refresh 2178' },
  { file: 'App.vue', fp: "loginBackendKind.value==='acp'", occurrences: 2, classification: 'ui-required', owner: 11, handling: 'pending', sites: 'loginTitle 2192-2194; handleLogin 9460' },
  { file: 'App.vue', fp: "loginBackendKind.value==='codex'", occurrences: 2, classification: 'ui-required', owner: 11, handling: 'pending', sites: 'loginTitle 2192; handleLogin 9455' },
  { file: 'App.vue', fp: "loginBackendKind==='acp'", occurrences: 2, classification: 'ui-required', owner: 11, handling: 'pending', sites: 'login backend toggle 307/308' },
  { file: 'App.vue', fp: "loginBackendKind==='codex'", occurrences: 3, classification: 'ui-required', owner: 11, handling: 'pending', sites: 'login toggle 298/299 + fields 346' },
  { file: 'App.vue', fp: "loginBackendKind==='opencode'", occurrences: 3, classification: 'ui-required', owner: 11, handling: 'pending', sites: 'login toggle 289/290 + fields 315' },
  // ----- components -----
  ...
  { file: 'components/StatusMonitorModal.vue', fp: "activeBackendKind==='codex'", occurrences: 2, classification: 'ui-required', owner: 20, handling: 'pending', sites: 'codex summary grid / token usage 971/1121' },
  ...
  { file: 'composables/backendMessageSend.openCode.ts', fp: "preflight.backend==='acp'", occurrences: 1, classification: 'ui-required', owner: 18, handling: 'pending', sites: 'acp mention parts 33' },
  { file: 'composables/backendMessageSend.preflight.ts', fp: "backend!=='codex'", occurrences: 1, classification: 'ui-required', owner: 18, handling: 'pending', sites: 'model availability gate 51' },
  { file: 'composables/backendMessageSend.preflight.ts', fp: "backend==='codex'", occurrences: 2, classification: 'ui-required', owner: 18, handling: 'pending', sites: 'model resolution 47/62' },
  ...
  { file: 'composables/useBackendMessageSend.ts', fp: "preflight.backend==='codex'", occurrences: 1, classification: 'ui-required', owner: 18, handling: 'pending', sites: 'codex send dispatch 75' },
  { file: 'composables/useBackendMessageSend.ts', fp: "params.activeBackendKind.value==='codex'", occurrences: 1, classification: 'capability-optional', owner: 18, handling: 'handled', sites: 'codex slash pre-dispatch 88' },
  ...
  { file: 'composables/useBackendSessionActions.ts', fp: "backendKind==='acp'", occurrences: 4, classification: 'ui-required', owner: 17, handling: 'pending', sites: 'delete/archive/unarchive/rename 218/262/312/339' },
  { file: 'composables/useBackendSessionActions.ts', fp: "backendKind==='codex'", occurrences: 4, classification: 'ui-required', owner: 17, handling: 'pending', sites: 'delete/archive/unarchive/rename 214/266/316/353' },
  { file: 'composables/useBackendSessionActions.ts', fp: "params.activeBackendKind.value!=='opencode'", occurrences: 2, classification: 'capability-optional', owner: 17, handling: 'handled', sites: 'opencode-only 385/413' },
  { file: 'composables/useBackendSessionActions.ts', fp: "params.activeBackendKind.value==='codex'", occurrences: 2, classification: 'capability-optional', owner: 17, handling: 'handled', sites: 'fork/revert codex-only (capability false for kimi) 508/539' },
  { file: 'composables/useBackendSessionLifecycle.ts', fp: "case:'codex'", occurrences: 1, classification: 'ui-required', owner: 17, handling: 'pending', sites: 'sessionProjectIdForBackend switch 44 (no default)' },
  { file: 'composables/useBackendSessionLifecycle.ts', fp: "case:'acp'", occurrences: 1, classification: 'ui-required', owner: 17, handling: 'pending', sites: 'sessionProjectIdForBackend switch 44 (no default)' },
  { file: 'composables/useBackendSessionLifecycle.ts', fp: "case:'opencode'", occurrences: 1, classification: 'ui-required', owner: 17, handling: 'pending', sites: 'sessionProjectIdForBackend switch 44' },
  { file: 'composables/useBackendSessionLifecycle.ts', fp: "params.activeBackendKind.value==='acp'", occurrences: 4, classification: 'ui-required', owner: 17, handling: 'pending', sites: 'create/abort/reuse 106/117/123/176' },
  { file: 'composables/useBackendSessionLifecycle.ts', fp: "params.activeBackendKind.value==='codex'", occurrences: 4, classification: 'ui-required', owner: 17, handling: 'pending', sites: 'create/openPicker/abort 84/136/165/189' },
...
const UNIONS: UnionEntry[] = [
  { file: 'components/ProviderManagerModal.vue', fp: "backendKind?:'opencode'|'codex'|'acp'", owner: 25, classification: 'ui-required', handling: 'pending', sites: 'prop type 717 omits kimi-web (vue-tsc narrowing)' },
