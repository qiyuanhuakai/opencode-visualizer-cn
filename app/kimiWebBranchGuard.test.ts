...
const BRANCHES: BranchEntry[] = [
  ...
  { file: 'App.vue', fp: "activeBackendKind==='kimi-web'", occurrences: 5, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'composer permission/mode/goal, card metadata, and file diff actions', kimiSignal: 'KimiWebComposerModes' },
  ...
  { file: 'components/ProjectPicker.vue', fp: "getActiveBackendKind()==='kimi-web'", occurrences: 1, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'listDirectory global Kimi directory browse', kimiSignal: 'browseDirectories' },
  { file: 'components/ProjectPicker.vue', fp: "getActiveBackendKind()!=='kimi-web'", occurrences: 1, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'allow Kimi to drill into home subdirectories when home contains .git', kimiSignal: 'isDrillDownLocked' },
