...
const BRANCHES: BranchEntry[] = [
  ...
  { file: 'App.vue', fp: "activeBackendKind.value==='kimi-web'", occurrences: 1, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'agentPickerState reports ready for the dedicated manual/auto/yolo option list', kimiSignal: 'agentPickerState' },
  ...
  { file: 'App.vue', fp: "activeBackendKind==='kimi-web'", occurrences: 2, classification: 'ui-required', owner: 25, handling: 'handled', sites: 'composer permission option branch and KimiWebComposerModes after-thinking branch', kimiSignal: 'KimiWebComposerModes' },
  ...
  { file: 'composables/backendMessageSend.preflight.ts', fp: "backend==='kimi-web'", occurrences: 1, classification: 'ui-required', owner: 18, handling: 'handled', sites: 'model resolution skip 48', kimiSignal: "backend === 'kimi-web'" },
  ...
  { file: 'composables/useBackendMessageSend.ts', fp: "preflight.backend==='kimi-web'", occurrences: 1, classification: 'ui-required', owner: 18, handling: 'handled', sites: 'kimi-web send dispatch 105 (fails closed without kimiWebApi)', kimiSignal: 'runKimiWebSend' },
