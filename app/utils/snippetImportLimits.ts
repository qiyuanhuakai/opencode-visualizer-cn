...
const MAX_TEXT_TRANSFORMER_TAGS = 256;
const MAX_TEXT_TRANSFORMER_TAG_LENGTH = 256;
export const MAX_TEXT_TRANSFORMER_TAG_DRAFT_LENGTH =
  MAX_TEXT_TRANSFORMER_TAGS * MAX_TEXT_TRANSFORMER_TAG_LENGTH +
  (MAX_TEXT_TRANSFORMER_TAGS - 1) * 2;
export const MAX_TEXT_TRANSFORMER_TRIGGER_LENGTH = 256;
const MAX_TEXT_TRANSFORMER_BODY_LENGTH = 1024 * 1024;
