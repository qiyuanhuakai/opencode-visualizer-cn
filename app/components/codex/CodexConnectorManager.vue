<template>
  <section class="codex-app-manager" :aria-label="t('codexPanel.connectorsTitle')">
    ...
    <div v-else-if="api.apps.value.length === 0" class="codex-empty">
      {{ api.connected.value ? t('codexPanel.connectorsNoConnectors') : t('codexPanel.connectToLoad') }}
    </div>
