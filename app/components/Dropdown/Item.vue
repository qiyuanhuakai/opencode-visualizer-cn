...
.ui-dropdown-item.is-active {
  background: var(--ui-dropdown-active-bg, rgba(59, 130, 246, 0.2));
  border: 1px solid var(--ui-dropdown-accent, rgba(59, 130, 246, 0.45));
}

.ui-dropdown-item:hover,
.ui-dropdown-item[aria-selected='true'] {
  background: var(--ui-dropdown-hover-bg, rgba(15, 23, 42, 0.9));
}
