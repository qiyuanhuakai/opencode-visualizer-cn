...
.ui-dropdown-search-input {
  ...
  border-radius: 5px;
  padding: 4px 10px;
  background: var(--ui-dropdown-control-bg, var(--region-top-dropdown-control-bg, rgba(30, 41, 59, 0.55)));
...
.ui-dropdown-search-input:focus {
  border-color: var(--ui-dropdown-accent, var(--region-top-dropdown-accent, #60a5fa));
}
