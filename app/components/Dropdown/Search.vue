...
.ui-dropdown-search-input {
  ...
  border-radius: 5px;
  padding: 4px 10px;
  background: var(--ui-dropdown-control-bg, var(--theme-surface-panel-muted, rgba(30, 41, 59, 0.55)));
...
.ui-dropdown-search-input:focus {
  border-color: var(--ui-dropdown-accent, var(--theme-border-accent, #60a5fa));
}

.ui-dropdown-search-input::placeholder {
  color: var(--ui-dropdown-text-muted, var(--theme-text-muted, #64748b));
  opacity: 1;
}
</style>
