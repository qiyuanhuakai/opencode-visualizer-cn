...
export const EXPECTED_PRELOAD_SCHEMA = { "topLevel": ["clipboard", "getAppVersion", "getPlatform", "localFile", "persistentStorage", "platform", "versions"], "clipboard": ["readText", "writeText"], "persistentStorage": ["getItem", "removeItem", "setItem"], "localFile": ["clearApplication", "close", "offChanged", "offError", "onChanged", "onError", "open", "selectApplication"], "versions": ["chrome", "electron", "node"] };
