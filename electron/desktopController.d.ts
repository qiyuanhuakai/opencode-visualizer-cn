import type { DesktopNotification, DesktopPreferences, DesktopState } from '../app/types/desktop';

export interface DesktopControllerOptions {
  readonly storage: { getItem(key: string): string | null; setItem(key: string, value: string): unknown };
  ...
  readonly updates: {
    ...
    configure(preferences: Pick<DesktopPreferences, 'autoCheckUpdates' | 'autoDownloadUpdates'>): void;
